...
RSpec.describe Invoice, type: :model do
  ...
  describe "instance methods" do
    ...
    it "total_revenue_with_bulk_discounts" do
      ...
      ii_2 = InvoiceItem.create!(invoice_id: invoice_2.id, item_id: item_2.id, quantity: 5, unit_price: 10, status: 0)
      ii_3 = InvoiceItem.create!(invoice_id: invoice_3.id, item_id: item_3.id, quantity: 2, unit_price: 8, status: 2)
      ii_4 = InvoiceItem.create!(invoice_id: invoice_4.id, item_id: item_4.id, quantity: 3, unit_price: 5, status: 1)
